...
class Config:
    ...
    VALUE_VIN_SUCCESS = "vin_success"
    VALUE_BOX_SUCCESS = "box_success"
    ...
    def __init__(self):
        ...
        self.vin_success = self.get_config(Config.TITLE_ACCOUNT, Config.VALUE_VIN_SUCCESS)
        self.box_success = self.get_config(Config.TITLE_ACCOUNT, Config.VALUE_BOX_SUCCESS)
